  ...
  <v-app>
    ...
    <v-navigation-drawer left app permanent>
          ...
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title class="title">
                <strong style="color:black">{{ $t("mainApp.wos") }}</strong
                ><span class="text-sm-h6">&trade;</span>
              </v-list-item-title>
              <v-list-item-subtitle>
                <span style="color: black"
                  ><strong>{{ $t("mainApp.api") }}</strong>
                  {{ $t("mainApp.exporter") }}</span
                >
              </v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
      ...
      <v-list>
        ...
        <v-list-item link :to="{ name: 'export-format' }">
          <v-list-item-content>
            <v-list-item-title> $t("mainApp.exportFormat")</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item link :to="{ name: 'genFile' }">
          <v-list-item-content>
            <v-list-item-title>{{ $t("mainApp.genFile") }}</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
      </v-list>
      <template v-slot:append>
        <v-list>
          <v-list-item link :to="{ name: 'about' }">
            <v-list-item-content>
              <v-list-item-title> {{ $t("mainApp.about") }}</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-list>
      </template>
...
@Component({})
export default class AppOld extends Vue {
